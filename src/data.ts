...
export const ExperienceSectionData: TimelineElementExperience[] = [
  {
    ...
    description: [
      "Instructed students on the basics of programming in Python and helped spark their interest in the field of computer science",
      "Developed an easy-to-understand project-based Python curriculum designed for high school and middle school students",
      "Taught students Python modules like PyGame and Matplotlib to create various games and complex physics simulations",
    ],
  ...
  },
  {
    ...
    description: [
      "Developed a full-stack application using the PERN (PostgreSQL, Express.js, React.js, Node.js) stack to assist thousands of high school students in the college admissions process via a virtual guidance counselor and summer program recommendations",
      "Implemented a matching algorithm for scholarship/summer programs and leveraged React.js to create a seamless UX on the landing page, dashboard, scholarships, and summer programs pages, resulting in a 25% increase in user retention",
      "Contributed to a cross-functional development team while following the Agile Scrum methodology and establishing weekly team goals/timelines, leading to a global user base of over 10,000 students and incubation at the Harvard Innovation Labs",
    ],
    skillsUsed: ["React.js", "Typescript", "PostgreSQL", "Java Spring", "AWS"],
    links: [],
  },
  {
    id: 3,
    ...
    date: "Jul 2022",
    description: [
      "Participated in a highly selective program (~10% out of 900+ applicants) to gain industry experience in IoT and cybersecurity",
      "Formulated and presented innovative solutions for mass transit challenges using Cisco technologies such as Meraki MR56 Camera systems, LoRaWAN, and CyberVision, resulting in increased rail ridership and enhanced rider safety",
      "Achieved NYC Extern of the Day by excelling in workshops, shadowing company executives, and demonstrating leadership and technical skills in IoT, AI/ML, and Meraki Solutions, among various other networking technologies",
    ],
  ...
  },
  {
    ...
    description: [
      "Designed and implemented algorithmic solutions to complex problems in game theory, graph theory, and linguistics using Python, enhancing skills in data analysis, decision-making under uncertainty, and quantitative trading strategies",
      "Achieved 7th place in Jane Street's Electronic Trading Challenge (ETC) by developing high-frequency trading algorithms in a competitive 6-hour trading session, resulting in one of the highest Profit-and-Loss (P&L) scores among 80+ participants",
      "Collaborated with International Math Olympians to complete intensive coursework in combinatorics and number theory",
    ],
  ...
  {
    id: 5,
    jobPosition: "Associate Software Engineer Intern",
    companyName: "Vertice AI",
    companyLogo: require("../src/assets/vertice-ai-logo.png"),
    location: "Durham, NC",
    date: "Jun 2024 – Aug 2024",
    description: [
      "Developed an analytics solution using Python, PostgreSQL, Express.js, React.js, and AWS technologies to assist credit unions in tracking growth/engagement and identifying marketing opportunities for specific members",
  ...
  {
    id: 6,
    jobPosition: "Backend Software Engineer Intern | Trading Infrastructure",
